...
function CardTwo({ formData, setFormData, setActiveCard, setIsLoading, setSelectedCard, componentProps, isLoading }) {
        ...
        <div className="flex flex-col gap-8 w-full">
            ...
            <div className="flex flex-col gap-6 w-full">
              <span className="flex items-center justify-between">
                ...
                <p className="text-[14.5px] font-medium text-gray-80">{formData?.serviceProviderName}</p>
              </span>
              <span className="flex items-center justify-between">
                <h3 className="text-[14.5px] text-gray-70 font-normal">Smart Card Number</h3>
                <p className="text-[14.5px] font-medium text-gray-80">{formData?.smartCardNumber}</p>
              </span>
              <span className="flex items-center justify-between">
