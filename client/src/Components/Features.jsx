...
function Features() {
  return (
    <div className="small-pc:pad6 pad4 w-full flex items-center justify-between gap-[20.46px]">
        ...
        <div className="flex-1 flex flex-col gap-[20.46px] h-[734.68px]">
            <div className="flex-1 h-full bg-[#FFF6E5] pt-3 pl-6 relative overflow-hidden rounded-[24.56px]">
                <div className="mr-auto mt-3 w-[50%] flex flex-col gap-[24.56px]">
                ...
                <img alt="gold" src={GoldImg} className="absolute bottom-0 right-0" />
            </div>

            <div className="flex-1 h-full bg-[#AEB7EF] relative overflow-hidden rounded-[24.56px]">
                <div className="ml-auto mt-16 mr-12 w-[50%] flex flex-col gap-[24.56px]">
                ...
                <img src={WIthdrawImg} alt="withdrawal" className="absolute left-0 top-4" />
            </div>
